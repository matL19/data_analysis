classdef lsfRISDwobblingHL1inertial1diffNI < lineshapeFunction
    
    properties
        params = struct('Delta_cm',[],'theta0_deg',[],'tr1',[],'T2',[]);
        g;
        c2;
        order;
        tpoints;
    ...
    methods
        ...
        function obj = lsfRISDwobblingHL1inertial1diffNI(params,str,aRFoptions) %constructor function
            if nargin == 0
                super_args = {};
            elseif nargin == 1 
